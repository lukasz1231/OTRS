  ...
  <div class="min-h-screen bg-gray-50 p-8">
    <div class="max-w-4xl mx-auto">
      <button
        ...
        class="mb-6 text-gray-500 hover:text-blue-600 flex items-center gap-2 cursor-pointer"
      >
        ← Wstecz
      </button>
      <div class="flex justify-between items-center mb-8">
        ...
        <button
          ...
          class="bg-blue-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-blue-700 cursor-pointer"
        >
          + Nowa Kolejka
        </button>
      </div>
      ...
      <div class="grid gap-4">
        <div
          v-for="q in queues"
          :key="q.id"
          class="bg-white p-5 rounded-xl shadow-sm flex justify-between items-center border border-gray-100"
        >
          <div>
          ...
          <div class="flex gap-3">
            <button
              ...
              class="px-4 py-2 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 font-semibold cursor-pointer"
            >
              Agenci
            </button>
            <button
              @click="deleteQueue(q.id)"
              class="px-4 py-2 text-red-500 hover:bg-red-50 rounded-lg cursor-pointer"
            >
              Usuń
            </button>
          </div>
      ...
      <div class="bg-white rounded-2xl p-8 w-full max-w-lg shadow-2xl">
        ...
        <div class="mb-6 max-h-48 overflow-y-auto space-y-2 border-b pb-4">
          ...
          >
            ...
            <button
              @click="removeUserFromQueue(u.id)"
        ...
        <div class="space-y-3">
          ...
          <div class="flex gap-2">
            ...
            <button
              ...
              class="bg-blue-600 text-white px-6 py-2 rounded-lg font-bold"
            >
              DODAJ
            </button>
          </div>
    ...
    >
      <div class="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl">
        ...
        <input
          ...
          type="text"
          class="w-full p-3 border rounded-lg mb-6 outline-none focus:ring-2 focus:ring-blue-500"
          placeholder="Nazwa (np. Serwis IT)"
        />
        <div class="flex gap-2">
          <button @click="showAddModal = false" class="flex-1 py-2 text-gray-500 font-medium">
            Anuluj
          </button>
          <button
            @click="createQueue"
...
const deleteQueue = async (id) => {
  if (confirm('Usunąć kolejkę?')) {
    try {
      ...
      alert('Nie można usunąć kolejki ze zgłoszeniami!')
      console.log(e)
    }
  }
}
