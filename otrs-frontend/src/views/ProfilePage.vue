    ...
    <main class="max-w-6xl mx-auto px-6 py-12">
      <div class="bg-white p-8 md:p-10 rounded-2xl shadow-sm border border-gray-100">
        ...
        <section>
          ...
          <div class="space-y-4">
            <div v-for="ticket in finalFilteredTickets" :key="ticket.id"
              ...
              <div class="bg-[#3B71A3] text-white px-6 py-3 flex justify-between items-center text-sm font-bold">
                <div class="flex items-center gap-3">
                  <span class="bg-white/20 px-2 py-0.5 rounded text-[10px] font-mono tracking-tighter uppercase">
                    ID: {{ ticket.publicId }}
                  </span>
              ...
              <div class="bg-[#7895A9] p-6 text-white text-sm">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                  <div class="md:col-span-3">
                    ...
                    <p class="leading-relaxed text-gray-100 bg-black/10 p-3 rounded-lg min-h-[60px] break-words">
                      {{ ticket.description }}
                    </p>
                  </div>
                  <div class="flex flex-col justify-start md:items-right space-y-4 border-l border-white/10 md:pl-6">
                    <div>
...
const finalFilteredTickets = computed(() => {
  return tickets.value.filter((t) => {
    // Zastąpiona funkcja getNormalizedStatus uproszczoną logiką
